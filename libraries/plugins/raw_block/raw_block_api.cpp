...
{
   public:
      raw_block_api_impl( weku::app::application& _app );

      std::shared_ptr< weku::plugin::raw_block::raw_block_plugin > get_plugin();

      weku::app::application& app;
};

raw_block_api_impl::raw_block_api_impl( weku::app::application& _app ) : app( _app )
{}

std::shared_ptr< weku::plugin::raw_block::raw_block_plugin > raw_block_api_impl::get_plugin()
{
...
raw_block_api::raw_block_api( const weku::app::api_context& ctx )
{
...
get_raw_block_result raw_block_api::get_raw_block( get_raw_block_args args )
{
   ...
   std::shared_ptr< weku::chain::database > db = my->app.chain_database();
