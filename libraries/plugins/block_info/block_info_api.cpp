...
#include <weku/plugins/block_info/block_info_api.hpp>
#include <weku/plugins/block_info/block_info_plugin.hpp>
...
{
   public:
      block_info_api_impl( weku::app::application& _app );

      std::shared_ptr< weku::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( weku::app::application& _app ) : app( _app )
{}

std::shared_ptr< weku::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const weku::app::api_context& ctx )
{
