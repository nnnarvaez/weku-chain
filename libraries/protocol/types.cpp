...
namespace fc
{
    ...
    {
        vo = weku::protocol::public_key_type( var.as_string() );
    }
    ...
    {
       vo = weku::protocol::extended_public_key_type( var.as_string() );
    }
    ...
    {
       vo = weku::protocol::extended_private_key_type( var.as_string() );
    }
} // fc
