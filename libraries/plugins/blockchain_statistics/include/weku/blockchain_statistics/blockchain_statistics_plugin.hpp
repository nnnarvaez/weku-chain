...
class blockchain_statistics_plugin : public weku::app::plugin
{
   public:
...
FC_REFLECT( weku::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( weku::blockchain_statistics::bucket_object, weku::blockchain_statistics::bucket_index )
