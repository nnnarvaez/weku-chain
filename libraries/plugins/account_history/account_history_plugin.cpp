#include <weku/account_history/account_history_plugin.hpp>
...
#define STEEM_NAMESPACE_PREFIX "weku::protocol::"

namespace weku { namespace account_history {
...
STEEMIT_DEFINE_PLUGIN( account_history, weku::account_history::account_history_plugin )
