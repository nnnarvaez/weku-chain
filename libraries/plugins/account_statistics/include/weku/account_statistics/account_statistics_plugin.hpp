...
class account_statistics_plugin : public weku::app::plugin
{
   public:
...
FC_REFLECT( weku::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
...
//SET_INDEX_TYPE( weku::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   weku::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
