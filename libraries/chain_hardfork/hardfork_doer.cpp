...
void hardfork_doer::perform_vesting_share_split( uint32_t magnitude )
{
   try
   {
...
void hardfork_doer::reset_virtual_schedule_time() {
...
void hardfork_doer::do_hardfork_19()
 {
...
void hardfork_doer::do_hardfork_22()
{
