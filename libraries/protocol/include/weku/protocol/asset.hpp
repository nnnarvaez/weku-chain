...
namespace fc {
    inline void to_variant( const weku::protocol::asset& var,  fc::variant& vo ) { vo = var.to_string(); }
    inline void from_variant( const fc::variant& var,  weku::protocol::asset& vo ) { vo = weku::protocol::asset::from_string( var.as_string() ); }
}

FC_REFLECT( weku::protocol::asset, (amount)(symbol) )
FC_REFLECT( weku::protocol::price, (base)(quote) )
