#include <weku/account_by_key/account_by_key_plugin.hpp>
...
account_by_key_plugin::account_by_key_plugin( weku::app::application* app )
...
STEEMIT_DEFINE_PLUGIN( account_by_key, weku::account_by_key::account_by_key_plugin )
