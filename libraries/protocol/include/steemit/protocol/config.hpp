...
#define STEEMIT_GENESIS_TIME                    (fc::time_point_sec(1525165200)) //1458835200
//GMT: Tuesday, May 1, 2018 10:00:00 AM
#define STEEMIT_MINING_TIME                     (fc::time_point_sec(1525168800)) //1458838800
...
#define STEEMIT_HARDFORK_REQUIRED_WITNESSES     6 // 17 of the 21 dpos witnesses (20 elected and 1 virtual time) required for hardfork. This guarantees 75% participation on all subsequent rounds.
...
#define STEEMIT_INFLATION_RATE_PERCENT_0_20     (500)
...
#define STEEMIT_INIT_SUPPLY                     int64_t(400000000000)
...
#define STEEMIT_MIN_FEEDS                       1 //(STEEMIT_MAX_WITNESSES/3) /// protects the network from conversions before price has been established
