...
FC_REFLECT_ENUM( weku::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( weku::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( weku::follow::follow_object, weku::follow::follow_index )

FC_REFLECT( weku::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( weku::follow::feed_object, weku::follow::feed_index )

FC_REFLECT( weku::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( weku::follow::blog_object, weku::follow::blog_index )

FC_REFLECT( weku::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( weku::follow::reputation_object, weku::follow::reputation_index )

FC_REFLECT( weku::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( weku::follow::follow_count_object, weku::follow::follow_count_index )

FC_REFLECT( weku::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( weku::follow::blog_author_stats_object, weku::follow::blog_author_stats_index );
