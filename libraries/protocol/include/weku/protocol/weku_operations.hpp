...
FC_REFLECT( weku::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( weku::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( weku::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( weku::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( weku::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( weku::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( weku::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( weku::protocol::feed_publish_operation, (publisher)(exchange_rate) )
FC_REFLECT( weku::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( weku::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( weku::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( weku::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( weku::protocol::chain_properties, (account_creation_fee)(maximum_block_size)(sbd_interest_rate) );

FC_REFLECT_TYPENAME( weku::protocol::pow2_work )
FC_REFLECT( weku::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( weku::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( weku::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( weku::protocol::account_create_with_delegation_operation,
            (fee)
            (delegation)
            (creator)
            (new_account_name)
...
FC_REFLECT( weku::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( weku::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( weku::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( weku::protocol::withdraw_vesting_operation, (account)(vesting_shares) )
FC_REFLECT( weku::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( weku::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( weku::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( weku::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( weku::protocol::blacklist_vote_operation, (voter)(badguy)(approve))
FC_REFLECT( weku::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( weku::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( weku::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( weku::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( weku::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( weku::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( weku::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( weku::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( weku::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( weku::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( weku::protocol::comment_payout_beneficiaries, (beneficiaries) )
FC_REFLECT_TYPENAME( weku::protocol::comment_options_extension )
FC_REFLECT( weku::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_steem_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( weku::protocol::escrow_transfer_operation, (from)(to)(sbd_amount)(steem_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( weku::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( weku::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( weku::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(steem_amount) );
FC_REFLECT( weku::protocol::challenge_authority_operation, (challenger)(challenged)(require_owner) );
FC_REFLECT( weku::protocol::prove_authority_operation, (challenged)(require_owner) );
FC_REFLECT( weku::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( weku::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( weku::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( weku::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT( weku::protocol::claim_reward_balance_operation, (account)(reward_steem)(reward_sbd)(reward_vests) )
FC_REFLECT( weku::protocol::delegate_vesting_shares_operation, (delegator)(delegatee)(vesting_shares) );
